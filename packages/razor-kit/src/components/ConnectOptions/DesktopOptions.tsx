...
import { ConnectModalIntro } from '../EthConnectModal/ConnectModalIntro';
...
import { ModalSizeContext, ModalSizeOptions } from '../../contexts/ModalSizeContext';
import { AppContext } from '../../contexts/AppContext';
import { I18nContext } from '../../contexts/I18nContext';
import { WalletButtonContext } from '../../contexts/WalletButtonContext';
...
export function DesktopOptions({ onClose }: { onClose: () => void }) {
  ...
  // This happened because of a mix up between EIP-6963 and RazorKit connectors.
  // The problem was finding the correct `wallet.id`. `WalletButton` uses RazorKit's id,
  // but EIP-6963 uses `rdns` for its id. We now don't merge EIP-6963 and RazorKit
                      ...
                      {wallets.map((wallet) => {
                        return (
                          <ModalSelection
                            ...
                            isRazorKitConnector={wallet.isRazorKitConnector}
                          />
                        );
                      })}
                    </Box>
