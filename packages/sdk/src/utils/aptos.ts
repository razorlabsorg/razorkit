...
export function composeType(address: string, struct: string, generics?: string[]): MoveStructId;
export function composeType(address: string, module: string, struct: string, generics?: string[]): MoveStructId;
