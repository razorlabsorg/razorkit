...
import { radio, ring } from './index.css';
      ...
      <Box position="relative">
        <Wrapper>
          ...
          <Text
            ...
            weight="semibold"
          >
            {'RazorKit allows you to fully customize color, border radius, wallet providers and a lot more — all through an easy-to-use API. Get a feel for it below!'}
          </Text>
        </Wrapper>
          ...
          >
            ...
            >
              <div style={{ position: 'relative' }}>
                ...
                {/* This div is placed on top of razorkit to make it non-interactive.*/}
