...
export interface MevmKitChain extends Chain {
...
/** @description Decorates an array of wagmi `Chain` objects with MevmKitChain property overrides */
export const provideMevmKitChains = <Chain extends MevmKitChain>(chains: readonly [Chain, ...Chain[]]): Chain[] =>
  chains.map((chain) => {
