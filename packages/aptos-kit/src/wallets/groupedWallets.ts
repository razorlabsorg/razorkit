...
export const isMevmKitConnector = (wallet: WalletInstance) => {
  return !!wallet.isMevmKitConnector;
};

export const isEIP6963Connector = (wallet: WalletInstance) => {
  return !!(
    !wallet.isMevmKitConnector &&
...
export const mevmKitConnectorWithWalletConnect = (
