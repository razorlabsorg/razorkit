import { IDefaultSuiWallet } from './types';

/**
 * A function that defines a wallet by freezing the provided parameters.
 *
 * @param {IDefaultSuiWallet} params - The parameters to define the wallet.
 * @return {IDefaultSuiWallet} The frozen wallet parameters.
 */
export function defineWallet(params: IDefaultSuiWallet) {
  return Object.freeze(params);
}

// register names of wallet adapters, used for detection
export enum PresetSuiWallet {
...
export const RazorSuiWallet = defineWallet({
  name: PresetSuiWallet.RAZOR_SUI_WALLET,
  label: 'Razor Wallet',
  iconUrl:
...
export const SuiWallet = defineWallet({
  name: PresetSuiWallet.SUI_WALLET,
  label: 'Sui Wallet',
  iconUrl:
...
export const EthosWallet = defineWallet({
  name: PresetSuiWallet.ETHOS_WALLET,
  label: 'Ethos Wallet',
  iconUrl:
...
export const MartianWallet = defineWallet({
  name: PresetSuiWallet.MARTIAN_WALLET,
